...
### My Top Activities on Github current are:
    ...
    - Configurations and Settings: Linting, Scripts, Pre-Commit, CI/CD (e.g. .editorconfig, .prettierrc, .htmlhint, .eslintrc, .stylelintrc, .gitignore, .gitattributes, .pre-commit-config.yaml,
...
- 🌱 I am currently learning ...
    ...
    - Hypermedia API Design v Dataset API Design
        - *HTMX*:
